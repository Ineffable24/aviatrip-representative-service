...
public class AirplaneValidator {
    ...
    public void validatePassengerSections(List<AirplaneRequest.AirplanePassengerSectionRequest> sections, int totalSeatCount) {
        ...
        long distinctClassCount = sections.stream()
                .map(AirplaneRequest.AirplanePassengerSectionRequest::getEnumSeatClass)
                .distinct()
                .count();
